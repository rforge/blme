...
test.blme.parsePrior.cov.prior.exceptions <- function()
{
  ...
  checkException(blme:::parsePrior(blmerFit, numeric(0)))
  checkException(blme:::parsePrior(blmerFit, list(numeric(0))));
  checkException(blme:::parsePrior(blmerFit, "not a prior"));
  checkException(blme:::parsePrior(blmerFit, list("not a", "prior")));
  checkException(blme:::parsePrior(blmerFit, "notAGroup ~ gamma"));
  
  checkException(blme:::parsePrior(blmerFit, "correlation(()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ correlation(()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ correlation(1 ~ gamma()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ correlation(0 ~ gamma)"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ correlation(notACoordinate ~ gamma)"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ correlation(1 ~ wishart)"));
  
  checkWarning(blme:::parsePrior(blmerFit, "correlation(gamma(notAParam = 0))"))
  checkException(blme:::parsePrior(blmerFit, "correlation(gamma(shape = 'not a number'))"));
  checkException(blme:::parsePrior(blmerFit, "correlation(gamma(shape = 0))"));
  checkException(blme:::parsePrior(blmerFit, "correlation(gamma(rate = 0))"));
  
  checkException(blme:::parsePrior(blmerFit, "spectral(()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ spectral(()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ spectral(1 ~ gamma()"));
  checkException(blme:::parsePrior(blmerFit, "g.1 ~ spectral(0 ~ gamma)"));
  
  checkWarning(blme:::parsePrior(blmerFit, "g.1 ~ spectral(gamma(notAParam = 0))"));
  
  checkException(blme:::parsePrior(blmerFit, "inverse.gamma(shape = 'not a number')"));
  checkException(blme:::parsePrior(blmerFit, "inverse.gamma(shape = 0)"));
  checkException(blme:::parsePrior(blmerFit, "inverse.gamma(scale = 0)"));
  
  checkException(blme:::parsePrior(blmerFit, "wishart(df = 'not a number')"));
  checkException(blme:::parsePrior(blmerFit, "wishart(df = 0)"));
  checkException(blme:::parsePrior(blmerFit, "wishart(scale = 'not a number')"));
  checkException(blme:::parsePrior(blmerFit, "wishart(scale = -0.01)"));
  checkException(blme:::parsePrior(blmerFit, "inverse.wishart(df = 'not a number')"));
  checkException(blme:::parsePrior(blmerFit, "inverse.wishart(df = 0)"));
  checkException(blme:::parsePrior(blmerFit, "inverse.wishart(inverse.scale = 'not a number')"));
  checkException(blme:::parsePrior(blmerFit, "inverse.wishart(inverse.scale = -0.01)"));

  checkException(blme:::parsePrior(blmerFit, "gamma(posterior.scale = 'not a scale')"));
  checkException(blme:::parsePrior(blmerFit, "gamma(data.scale = 'not a scale')"));
  ...
  checkWarning(blme:::parsePrior(blmerFit, "g.1 ~ gamma"));
  checkException(blme:::parsePrior(blmerFit, "-1 ~ gamma"));
}
